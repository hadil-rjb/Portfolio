...
const Stage = [
  {
    ...
    description:
      "seeking an internship to apply software development and system design skills",
  },
  {
    main: "Aspiring Web Developer",
    description:
      "interested in building responsive and dynamic web applications",
  },
  {
    main: "UI/UX Enthusiast",
    description:
      "aiming to create intuitive and user-friendly digital experiences",
  },
  {
    main: "Innovative Problem Solver",
    description:
      "looking to contribute to projects that combine creativity and technology",
  },
];
